    ...
    if (isset($_POST['reset'])){
        ...
        if ($count > 0) {
            ...
            if ($npassword == $cpassword) {
                $new_password = md5($npassword);
                $reset_password = $con->query("UPDATE account SET password = '$new_password' WHERE user_ID = '$user_id'") or die(mysqli_error($con));
                $page='../index.php';
        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="well1 bg-white shadow-sm p-4">
                      <div class="mt-4" style="width:250px;padding-top:30px;"><img src="../pictures/logo_k_login.svg" alt="Kebo Group Presents"></div>
                      <form action="" method="post" style="padding-right:20px;">
                        ...
                        <hr>
                          ...
                          <div class="form-group">
                              <label style="color: #A35448; font-weight: bold;">New Password</label>
                              <input type="password" name="npassword" style="<?php echo $error_class2 ?>" class="form-control rounded-0" required>
                          </div>
                          <div class="form-group">
                              <label style="color: #A35448; font-weight: bold;">Confirm Password</label>
