            ...
            <div class="col-lg-12">
                ...
                <form method="post" enctype="multipart/form-data">
                  ...
                  <?php
                      ...
                      if (isset($_POST['adduser'])) {
                          ...
                          $sql=$con->query("
                                              INSERT INTO account(fullname,username,password,pin,user_year,photo)
                                              VALUES('$names','$username','$hashedpassword','$pin','$today','$photo')
                          ...
                          if ($sql) {
                              ...
                              echo "<br><span class='badge badge-danger white-text' style='margin-left: 60px; padding: 10px; font-size: 12px;'>Profile Not Added &nbsp;&nbsp;&nbsp;<a href='add_user.php' data-icon='&#x40;' class='fs1 white-text' style='font-size: 15px;'></a></span>";
                          }
                        }
                        else {
                          echo "<br><span class='badge badge-danger white-text' style='margin-left: 60px; padding: 10px; font-size: 12px;'>Check password &nbsp;&nbsp;&nbsp;<a href='add_user.php' data-icon='&#x40;' class='fs1 white-text' style='font-size: 15px;'></a></span>";
                        }
                      }
                  ?><br></div></div>
                ...
                <div class="row">
                    <div class="col-md-4">
                      <div class="well shadow-sm bg-white p-4">
                        <div class="form-group">
                            <label style="color:#A35448;">Full Name</label>
                    ...
                    <div class="col-md-4">
                      <div class="well shadow-sm bg-white p-4">
                        <div class="form-group">
                            <label style="color:#A35448;">Set Password</label>
                    ...
                    <div class="col-md-4">
                      <div class="well shadow-sm bg-white p-4">
                        <div class="form-group">
                            <label style="color:#A35448;">Profile Photo</label>
