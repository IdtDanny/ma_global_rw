                        ...
                        <?php
                          ...
                          <?php while($row = mysqli_fetch_array($sql)):
                            ...
                            <tr>
                              ...
                              <td><form method="post"><a href="others_delete.php?No=<?php echo $row['No'] ?>" style="font-size: 19px;font-weight: bold;display: block;" class="text-danger text-center" name="delete" title="Delete Item">&times;</a></form></td>
                            </tr>
                          <?php endwhile ?>
                          </table>
                        <?php endif ?>
                  ...
                  <!-- Search form -->
                    <?php
                      ...
                      <?php while($row = mysqli_fetch_array($sql)):
                        ...
                        <tr>
                          <td colspan="8"><a href="others.php" style="font-size: 19px;font-weight: bold;display: block;" class="text-danger text-center" name="delete" title="Delete Item"><i>Cancel &nbsp;</i></a></form></td>
                        </tr>
