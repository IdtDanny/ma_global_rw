                              ...
                              <!--  -->
                                <?php
                                  ...
                                  <table class="table table-sm">
                                          ...
                                          ?>
                          					<tr>
                                      <td><span style="font-size: 19px;font-weight: bold;display: block; color: #A35448" data-icon="&#x4e;" class="text-center"></span></td>
                                      ...
                                      <td><?php echo $row['SPrix'] ?></td>
                          						...
                          						<td><form method="post"><a href="cement_delete.php?No=<?php echo $row['No'] ?>" style="font-size: 19px;font-weight: bold;display: block;" class="text-danger text-center" name="delete" title="Delete Item">&times;</a></form></td>
                          					</tr>
                          				<?php endwhile ?>
                          				</table>
                                <?php endif ?>
                          ...
                          <!-- Search form -->
                            <?php
                              ...
                              <table class="table table-sm">
                                ...
                                <tr>
                                  <td colspan="8"><a href="cement.php" style="font-size: 19px;font-weight: bold;display: block;" class="text-danger text-center" name="delete" title="Delete Item"><i>Cancel &nbsp;</i></a></form></td>
                                </tr>
