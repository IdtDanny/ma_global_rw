<?php
    ...
    # Date validation and daily records
    if (isset($_POST['start_record'])) {
      $date = $_POST['date'];
      // $middle = strtotime($old_date);
      // $date = date('F j, Y', $middle);
      $_SESSION['today'] = $date;
                ...
                <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-5"><br>
                        <div class="well shadow-sm bg-white p-4" style="border-radius: 15px;">
                            <div class="teal-text text-center">
                              <!-- <img src="../pictures/logo_k.svg" style="height: 60px; width: 400px;"> -->
                            </div>
                            <!-- <hr> -->
