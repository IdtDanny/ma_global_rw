                ...
                <div class="well bg-white shadow-sm p-4">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label style="color: #298; font-weight: bold;">User Pin</label>
                            <input type="text" name="user_pin" style="<?php echo $error_class2 ?>" class="form-control rounded-0" required>
                        </div>
                        <div class="form-group">
                            <label style="color: #298; font-weight: bold;">Joined Year</label>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col lg-3">
                              <input type="submit" name="verify" value="Verify" style="font-size: 13px;" id="mybtn" class="btn btn-block shadow-0 btn-sm teal white-text">
                            </div>
                            <div class="col lg-3">
