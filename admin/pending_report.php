                	...
                	<!-- <div class="col-md-3">
                		<!-
                          <div class="well shadow-sm bg-white p-4">
                            <h3 class="blue-text" style="font-family:Century Gothic;">Recharge:</h3><br>
                            <form class="form">
                      ...
                      <div class="col-md-12">
                        <!-- <div class="row"> -->
                          <!-- <div class="col-md-2">
                            <div class="well shadow-sm bg-white p-4">
                              <center> -->
                                ...
                                <!-- </form> -->
                                <!-- <form method="post" enctype="multipart/form-data">
                                  <button name="today" class="btn blue btn-sm btn-block white-text active">Today</a>
                                  <button name="alles" class="btn blue white-text btn-sm btn-block ">All Pending Report</button></a> -->
                                  <!-- <button name="dreisig" class="btn blue btn-sm btn-block white-text">Last 4 Weeks</button> -->
                                <!-- </form>
                          ...
                          <!-- <div class="col-md-10"> -->
                           <div class="well shadow-sm bg-white p-4">
                             <div class="row">
                               <div class="col-md-10">
                  			          <p class="display-4 blue-text text-center">
                  				              All Pending Reports</p>
                               </div>
                               <div class="col-md-1">
                                 <form method="POST">
                                   <td class="text-center"><button style="border: none; color: none;" class="white" Type="submit" name="getphp" title="download"><div data-icon='&#xe071;' style="font-size: 25px; color:#2196f3;"></div></button></td>
                                 </form>
                               </div>
                             </div>
                         <?php
                        ...
                        ?>
                          ...
                          <table class="table table-sm ">
                              ...
                              <td><span class="fs1" aria-hidden="true" style="font-size: 19px; color:#2196f3;font-weight: bold;" data-icon="&#x4e;" ></span></td>
                          ...
                          <?php
                           ...
                           ?>
                           <tr>
                             <td colspan="2"><?php echo "<h3 class='blue-text' style='font-size: 17px;font-weight: bold;'>Grand Total</h3>"; ?></td>
                             <td><?php echo "<h3 class='blue-text' style='font-size: 15px;font-weight: bold;'>" . $row_cement['total_cement'] ."&nbsp;Sac</h3>"; ?></td>
                             <td><?php echo "<h3 class='blue-text' style='font-size: 15px;font-weight: bold;'>" . $row_others['total_others'] ."&nbsp;Rwf</h3>"; ?></td>
                             <td><?php echo "<h3 class='blue-text' style='font-size: 15px;font-weight: bold;'>" . $row_profit['total_profit'] ."&nbsp;Rwf</h3>"; ?></td>
                             <td><?php echo "<h3 class='blue-text' style='font-size: 15px;font-weight: bold;'>" . $row_expenses['total_expenses'] ."&nbsp;Rwf</h3>"; ?></td>
                             <td><?php echo "<h3 class='blue-text' style='font-size: 15px;font-weight: bold;'>" . $row_remain['total_Remain'] ."&nbsp;Rwf</h3>"; ?></td>
                             <form method="POST">
                             <td class="text-center" colspan="2"><button style="border: none; margin-top: -4px; color: none;" class="white" Type="submit" name="getphp" title="download"><div data-icon='&#xe071;' style="font-size: 20px; color:#2196f3;"></div></button></td>
                             </form>
                           </tr>
                         ...
                         <?php endwhile ?>
                            ...
                            <tr>
                              <td colspan="9" class="blue-text text-muted text-center mt-3" style="font-size: 16px;"><i>Consider the current status</i></td>
                            </tr>

                         <!-- <tr>
                           <td colspan="4"><span class="fs1" aria-hidden="true" style="font-size: 19px; color:#2196f3;font-weight: bold;" data-icon="&#xe071;" title="download"></span</td> -->
                  				</table>
                			</p>
                		</div>
                  </div>
