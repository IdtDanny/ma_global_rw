            ...
            if ( $password == $oldpassword) {
                ...
                if( $newpassword == $cpassword ){
                    ...
                    if ( $exec ) {
                        ...
                        echo "<span class='badge teal white-text' style='margin-left: 60px; padding: 10px; font-size: 12px;'>Successfully Updated &nbsp;&nbsp;&nbsp;<a href='edit.php' data-icon='&#x40;' class='fs1 white-text' style='font-size: 15px; margin-top: -5px;'></a></span>";
                ...
                echo "<span class='badge badge-danger white-text' style='margin-left: 60px; padding: 10px; font-size: 12px;'>Invalid Old Password &nbsp;&nbsp;&nbsp;<a href='index.php' data-icon='&#x40;' class='fs1 white-text' style='font-size: 15px;'></a></span>";
                  ...
                  <p class="display-4 teal-text text-center">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="well shadow-sm bg-white p-4">
                          <div class="form-group">
                                <label style="color: #298;">Names</label>
                          ...
                          <div class="form-group">
                              <label style="color: #298;">Pin</label>
                      ...
                      <div class="col-md-6">
                        <div class="well shadow-sm bg-white p-4">
                          <div class="form-group">
                              <label style="color: #298;">Old Password</label>
