 ...
 ?>
                ...
                <div class="row">
                    ...
                    <div class="row withdraw-modal">
                       ...
                       <div class="well shadow-sm bg-white p-4">
                         <div class="row">
                           ...
                           <div class="col-md-1"><br>
                             <span class="fs1 ml-3" aria-hidden="true" style="font-size: 30px; color:#298;font-weight: bold;" data-icon="&#xe050;" id="withdraw_btn" title="Add Item"></span>
                           </div>
                         </div>
                      ...
                      <?php endwhile ?>
                      <tr>
                        <td colspan="8"><a href="daily.php" style="font-size: 19px;font-weight: bold;display: block;" class="text-danger text-center" name="delete" title="Delete Client"><i>Cancel &nbsp;</i></a></form></td>
                      </tr>
                      </table>
                    <?php endif ?>
